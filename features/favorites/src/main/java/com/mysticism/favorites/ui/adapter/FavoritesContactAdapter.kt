package com.mysticism.favorites.ui.adapter
...
import com.mysticism.favorites.R

class FavoritesContactAdapter(
    private val onFavoriteClick: (Data) -> Unit,
    private val onItemClick: (Data) -> Unit
) : ListAdapter<Data, FavoritesContactAdapter.ContactViewHolder>(DIFF_CALLBACK) {
    ...
    class ContactViewHolder(
        ...
        private val imageView2 = itemView.findViewById<ImageView>(R.id.imageView2)
        ...
        fun bind(contact: Data, position: Int) {
            ...
            contact.imagePath?.let {
                Glide.with(itemView.context)
                    .load(it)
                    .placeholder(com.mysticism.phonelist.R.drawable.list_avatar_bg)
                    .into(imageView2)
            }
        }
    }
